...
export default function FeedPage() {
    ...
    return (
        <>
            ...
            {/* Bottom Navigation - Outside main to avoid stacking context issues */}
            <nav className='fixed bottom-0 left-0 right-0 h-16 bg-white border-t flex items-center justify-around px-4 z-[9999]'>
